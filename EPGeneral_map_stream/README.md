...
兼容修复、日志和验收步骤见 [AGV 建图部署说明](../documents/devices/ground_air_agv/DEPLOYMENT_GUIDE.md#documents-ground-air-agv-mapping-deployment-md)。
...
从零安装与故障回滚见[部署指南](../documents/USER_MANUAL.md#documents-deployment-guide-md)，实测范围见[设备记录](../README.md)。

...
PROFILE = ROOT / 'devices/go2/profiles/go2_robot2'
INTEGRATION = ROOT / 'devices/go2/EPGeneral_go2_integration'
...
class Go2Robot2ProfileTests(unittest.TestCase):
    ...
    def test_mapping_preview_and_artifact_frames_remain_distinct(self):
        ...
        tree = ET.parse(ROOT / 'EPGeneral_map_stream/launch/mapping_prerequisites_go2_robot2.launch')

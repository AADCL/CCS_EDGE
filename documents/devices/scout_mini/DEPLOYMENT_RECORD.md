...
<a id="deploy-records-ugv-001-deployment-md"></a>

<a id="deploy-records-ugv-001-deployment-md-ugv_001-部署与验收记录"></a>
# UGV_001 部署与验收记录

合并日期：2026-09-11；操作基线：CCS 0.23.1。此文件是该设备唯一的部署记录入口，后续按日期追加。

<a id="deploy-records-ugv-001-deployment-md-当前入口"></a>
## 当前入口

- 设备：UGV_001；profile：`scout_mini`；端侧：`nvidia@192.168.50.120`。
- [配置与脚本](../../../devices/scout_mini/profiles/scout_mini)保持原位置；[从零部署](../../USER_MANUAL.md#documents-deployment-guide-md)、[接口填写](../../INTERFACE_REFERENCE.md#documents-config-topic-reference-md)、[使用手册](../../USER_MANUAL.md#documents-user-manual-md)、[设备索引](../../../README.md)。
- 七公共包、D435i、scout_finalize 和外部导航。注意 RealSense → Scout → livox_fastlio underlay 顺序；原始雷达、遥测 odom 与建图 pose 不同。

<a id="deploy-records-ugv-001-deployment-md-历史材料与来源校验"></a>
## 历史材料与来源校验
...
| --- | --- | --- |
| `documents/SCOUT_MINI_DEPLOYMENT.md` | `80f18d8df7424a22824314fe18577aaba5fcaa015c650b199ec246e34fad9399` | [材料 1](DEPLOYMENT_RECORD.md#deploy-records-ugv-001-deployment-md-source-1) |
| `documents/SCOUT_MINI_DEPLOYMENT_LOG.md` | `5995bc2392555101c7ad38e564af10c225d3a689c65f45db77cc621b14f55e59` | [材料 2](DEPLOYMENT_RECORD.md#deploy-records-ugv-001-deployment-md-source-2) |

<a id="deploy-records-ugv-001-deployment-md-source-1"></a>

<a id="deploy-records-ugv-001-deployment-md-历史材料-1documentsscout_mini_deploymentmd"></a>
## 历史材料 1：documents/SCOUT_MINI_DEPLOYMENT.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-ugv-001-deployment-md-s1-松灵-scout-mini-端侧部署说明"></a>

<a id="deploy-records-ugv-001-deployment-md-松灵-scout-mini-端侧部署说明"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s1-设备与目录"></a>

<a id="deploy-records-ugv-001-deployment-md-设备与目录"></a>
#### 设备与目录
...
<a id="deploy-records-ugv-001-deployment-md-s1-安装与构建"></a>

<a id="deploy-records-ugv-001-deployment-md-安装与构建"></a>
#### 安装与构建
...
<a id="deploy-records-ugv-001-deployment-md-s1-启动与停止"></a>

<a id="deploy-records-ugv-001-deployment-md-启动与停止"></a>
#### 启动与停止
...
<a id="deploy-records-ugv-001-deployment-md-s1-验证"></a>

<a id="deploy-records-ugv-001-deployment-md-验证"></a>
#### 验证

<a id="deploy-records-ugv-001-deployment-md-s1-v0191-重复重定位验收"></a>

<a id="deploy-records-ugv-001-deployment-md-v0191-重复重定位验收"></a>
##### v0.19.1 重复重定位验收
...
<a id="deploy-records-ugv-001-deployment-md-s1-v0190-遥测修复验收"></a>

<a id="deploy-records-ugv-001-deployment-md-v0190-遥测修复验收"></a>
##### v0.19.0 遥测修复验收
...
<a id="deploy-records-ugv-001-deployment-md-s1-v0190-现场记录2026-08-25"></a>

<a id="deploy-records-ugv-001-deployment-md-v0190-现场记录2026-08-25"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s1-故障排查"></a>

<a id="deploy-records-ugv-001-deployment-md-故障排查"></a>
#### 故障排查
...
<a id="deploy-records-ugv-001-deployment-md-source-2"></a>

<a id="deploy-records-ugv-001-deployment-md-历史材料-2documentsscout_mini_deployment_logmd"></a>
## 历史材料 2：documents/SCOUT_MINI_DEPLOYMENT_LOG.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-ugv-001-deployment-md-s2-scout-mini-部署日志"></a>

<a id="deploy-records-ugv-001-deployment-md-scout-mini-部署日志"></a>
### Scout Mini 部署日志

<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-28-epgeneral_map_stream-v0120-联合建图部署验证"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-28-epgeneral_map_stream-v0120-联合建图部署验证"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-27-v043-航点可达性修复部署"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-27-v043-航点可达性修复部署"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-27-v042-tf-listener-修复部署"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-27-v042-tf-listener-修复部署"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-27-v041-执行会话修复部署"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-27-v041-执行会话修复部署"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-27-epgeneral_map_stream-v0110-增量部署"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-27-epgeneral_map_stream-v0110-增量部署"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-27-v040-源码增量"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-27-v040-源码增量"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-v0211-任务失败修复"></a>

<a id="deploy-records-ugv-001-deployment-md-v0211-任务失败修复"></a>
#### v0.21.1 任务失败修复
...
<a id="deploy-records-ugv-001-deployment-md-s2-v0210-scout-task-adapter-deployment"></a>

<a id="deploy-records-ugv-001-deployment-md-v0210-scout-task-adapter-deployment"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-25-v0191-重复重定位增量部署"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-25-v0191-重复重定位增量部署"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-25-v0190-遥测与活动地图增量部署"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-25-v0190-遥测与活动地图增量部署"></a>
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-24-计划与环境盘点"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-24-计划与环境盘点"></a>
#### 2026-08-24 计划与环境盘点
...
<a id="deploy-records-ugv-001-deployment-md-s2-部署执行记录"></a>

<a id="deploy-records-ugv-001-deployment-md-部署执行记录"></a>
#### 部署执行记录
...
<a id="deploy-records-ugv-001-deployment-md-s2-待处理的设备问题"></a>

<a id="deploy-records-ugv-001-deployment-md-待处理的设备问题"></a>
#### 待处理的设备问题
...
<a id="deploy-records-ugv-001-deployment-md-s2-2026-08-24-epgeneral_map_stream-真机部署与验收"></a>

<a id="deploy-records-ugv-001-deployment-md-2026-08-24-epgeneral_map_stream-真机部署与验收"></a>
...
<a id="deploy-records-ugv-001-deployment-md-后续记录填写格式"></a>
## 后续记录填写格式

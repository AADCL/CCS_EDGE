...
<a id="deploy-records-agv-001-deployment-md"></a>

<a id="deploy-records-agv-001-deployment-md-agv_001-部署与验收记录"></a>
# AGV_001 部署与验收记录

合并日期：2026-09-11；操作基线：CCS 0.23.1。此文件是该设备唯一的部署记录入口，后续按日期追加。

<a id="deploy-records-agv-001-deployment-md-当前入口"></a>
## 当前入口

- 设备：AGV_001；profile：`ground_air_agv`；端侧：`bitcq@192.168.50.130`。
- [配置与脚本](../../../devices/ground_air_agv/profiles/ground_air_agv)保持原位置；[从零部署](../../USER_MANUAL.md#documents-deployment-guide-md)、[接口填写](../../INTERFACE_REFERENCE.md#documents-config-topic-reference-md)、[使用手册](../../USER_MANUAL.md#documents-user-manual-md)、[设备索引](../../../README.md)。
...
<a id="deploy-records-agv-001-deployment-md-历史材料与来源校验"></a>
## 历史材料与来源校验
...
| --- | --- | --- |
| `deploy/ground_air_agv/DEPLOYMENT.md` | `85d9613c2397da0a963acb13403154d88343879c5325039656ddaead48c69bd1` | [材料 1](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-1) |
| `documents/GROUND_AIR_AGV_DEPLOYMENT.md` | `5454ea56eceb59ddfbe2dee38360d83c69580c74346046f4fd925d252be5dcbc` | [材料 2](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-2) |
| `documents/GROUND_AIR_AGV_DEPLOYMENT_LOG.md` | `065c54fe5973e731864fde6f2c61710d79f781cbb828e7f23b2963a1870489cd` | [材料 3](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-3) |
| `documents/GROUND_AIR_AGV_MAPPING_DEPLOYMENT.md` | `9b1614d1b6277e76d78ff2195551ce84c7c792945f608fa8dafc31e63c57dacf` | [材料 4](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-4) |
| `documents/GROUND_AIR_AGV_MAPPING_DEPLOYMENT_LOG.md` | `62f41fb0d6069dcd08449660f5b636bfa2db3510c3937de1f14bbce060e64574` | [材料 5](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-5) |
| `documents/GROUND_AIR_AGV_RELOCALIZATION_DEPLOYMENT.md` | `2d89107dbd5dd0ac896ed1b69ba96be39f2cca87bcd5bad9778642f955422061` | [材料 6](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-6) |
| `documents/GROUND_AIR_AGV_RELOCALIZATION_DEPLOYMENT_LOG.md` | `f46c76d2af026eaf56838525a3f0447f98daaa83411ccab9d3a27cf655a8c8b2` | [材料 7](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-7) |
| `documents/GROUND_AIR_AGV_TASK_DEPLOYMENT.md` | `5cb310df65427af9b97b4e582e444427ce0c576cd5e6d4658091391fd6ba11b1` | [材料 8](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-8) |
| `documents/GROUND_AIR_AGV_TASK_DEPLOYMENT_LOG.md` | `92c254bc18a6f407de23042443ea1823e908bfacd7e5ffb268ab611caff7db6d` | [材料 9](DEPLOYMENT_RECORD.md#deploy-records-agv-001-deployment-md-source-9) |

<a id="deploy-records-agv-001-deployment-md-source-1"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-1deployground_air_agvdeploymentmd"></a>
## 历史材料 1：deploy/ground_air_agv/DEPLOYMENT.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s1-ground-air-agv-ccs-edge-deployment"></a>

<a id="deploy-records-agv-001-deployment-md-ground-air-agv-ccs-edge-deployment"></a>
### Ground-Air AGV CCS Edge Deployment

首次从源码或端侧 ZIP 安装，请先完成[使用手册的 Ground-Air 首次安装补充](../../USER_MANUAL.md#documents-user-manual-md-ground-air-%E9%A6%96%E6%AC%A1%E5%AE%89%E8%A3%85%E8%A1%A5%E5%85%85)，包括 launch/override、源脚本执行权限、用户服务与日志目录；本页后续增量更新步骤以已有部署为前提。
...
<a id="deploy-records-agv-001-deployment-md-source-2"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-2documentsground_air_agv_deploymentmd"></a>
## 历史材料 2：documents/GROUND_AIR_AGV_DEPLOYMENT.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s2-空地-agv-端侧部署说明"></a>

<a id="deploy-records-agv-001-deployment-md-空地-agv-端侧部署说明"></a>
### 空地 AGV 端侧部署说明

CCS 0.23.1 当前入口：[使用手册](../../USER_MANUAL.md#documents-user-manual-md) · [接口与配置](../../INTERFACE_REFERENCE.md#documents-interface-reference-md)。本页保留设备专项步骤；运行配置以脚本传入的工作空间 config/profile 为准，不能只修改包内默认 YAML。

<a id="deploy-records-agv-001-deployment-md-s2-设备与边界"></a>

<a id="deploy-records-agv-001-deployment-md-设备与边界"></a>
#### 设备与边界
...
<a id="deploy-records-agv-001-deployment-md-s2-一键启动组件"></a>

<a id="deploy-records-agv-001-deployment-md-一键启动组件"></a>
#### 一键启动组件
...
<a id="deploy-records-agv-001-deployment-md-s2-服务管理"></a>

<a id="deploy-records-agv-001-deployment-md-服务管理"></a>
#### 服务管理
...
<a id="deploy-records-agv-001-deployment-md-s2-建图与重定位响应"></a>

<a id="deploy-records-agv-001-deployment-md-建图与重定位响应"></a>
#### 建图与重定位响应
...
完整细节见 [GROUND_AIR_AGV_MAPPING_DEPLOYMENT.md](DEPLOYMENT_GUIDE.md#documents-ground-air-agv-mapping-deployment-md)。

<a id="deploy-records-agv-001-deployment-md-s2-构建与日志"></a>

<a id="deploy-records-agv-001-deployment-md-构建与日志"></a>
#### 构建与日志
...
<a id="deploy-records-agv-001-deployment-md-s2-静态验收"></a>

<a id="deploy-records-agv-001-deployment-md-静态验收"></a>
#### 静态验收
...
<a id="deploy-records-agv-001-deployment-md-source-3"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-3documentsground_air_agv_deployment_logmd"></a>
## 历史材料 3：documents/GROUND_AIR_AGV_DEPLOYMENT_LOG.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s3-空地-agv-部署日志"></a>

<a id="deploy-records-agv-001-deployment-md-空地-agv-部署日志"></a>
### 空地 AGV 部署日志

<a id="deploy-records-agv-001-deployment-md-s3-2026-09-05-手动启动与建图兼容修复"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-05-手动启动与建图兼容修复"></a>
...
- `epgeneral_map_stream` v0.13.2 同步版本兼容、部署门禁和当前操作说明；逐文件修复未重启常驻服务，端侧聚焦测试最终 25/25，通过实际预检及一次无运动建图闭环。最终服务仍为 `disabled/inactive`，手动启动的基础栈继续运行，stage 已回到 BASE；完整备份、地图校验值和清理结果见 [建图部署日志](DEPLOYMENT_GUIDE.md#documents-ground-air-agv-mapping-deployment-log-md)。
- 以下旧批次中的路径、启用状态和测试结果按历史保留，不作为当前上电启动或版本要求。


<a id="deploy-records-agv-001-deployment-md-s3-2026-08-31-a8-mini-srt-视频部署"></a>

<a id="deploy-records-agv-001-deployment-md-2026-08-31-a8-mini-srt-视频部署"></a>
...
<a id="deploy-records-agv-001-deployment-md-s3-2026-08-31-通信服务纳入一键启动"></a>

<a id="deploy-records-agv-001-deployment-md-2026-08-31-通信服务纳入一键启动"></a>
...
<a id="deploy-records-agv-001-deployment-md-s3-2026-08-31-基础部署"></a>

<a id="deploy-records-agv-001-deployment-md-2026-08-31-基础部署"></a>
#### 2026-08-31 基础部署
...
<a id="deploy-records-agv-001-deployment-md-source-4"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-4documentsground_air_agv_mapping_deploymentmd"></a>
## 历史材料 4：documents/GROUND_AIR_AGV_MAPPING_DEPLOYMENT.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s4-ground-air-agv-建图部署说明"></a>

<a id="deploy-records-agv-001-deployment-md-ground-air-agv-建图部署说明"></a>
### Ground-Air AGV 建图部署说明

CCS 0.23.1 当前入口：[使用手册](../../USER_MANUAL.md#documents-user-manual-md) · [接口与配置](../../INTERFACE_REFERENCE.md#documents-interface-reference-md)。本页保留设备专项步骤；运行配置以脚本传入的工作空间 config/profile 为准，不能只修改包内默认 YAML。

<a id="deploy-records-agv-001-deployment-md-s4-适用范围"></a>

<a id="deploy-records-agv-001-deployment-md-适用范围"></a>
#### 适用范围
...
<a id="deploy-records-agv-001-deployment-md-s4-手动启动顺序与所有权"></a>

<a id="deploy-records-agv-001-deployment-md-手动启动顺序与所有权"></a>
#### 手动启动顺序与所有权
...
<a id="deploy-records-agv-001-deployment-md-s4-实时预览坐标系契约"></a>

<a id="deploy-records-agv-001-deployment-md-实时预览坐标系契约"></a>
#### 实时预览坐标系契约
...
<a id="deploy-records-agv-001-deployment-md-s4-建图指令流程"></a>

<a id="deploy-records-agv-001-deployment-md-建图指令流程"></a>
#### 建图指令流程
...
<a id="deploy-records-agv-001-deployment-md-s4-增量部署"></a>

<a id="deploy-records-agv-001-deployment-md-增量部署"></a>
#### 增量部署
...
<a id="deploy-records-agv-001-deployment-md-s4-静态验收"></a>

<a id="deploy-records-agv-001-deployment-md-静态验收-1"></a>
#### 静态验收
...
<a id="deploy-records-agv-001-deployment-md-s4-产物与日志"></a>

<a id="deploy-records-agv-001-deployment-md-产物与日志"></a>
#### 产物与日志
...
<a id="deploy-records-agv-001-deployment-md-s4-回滚"></a>

<a id="deploy-records-agv-001-deployment-md-回滚"></a>
#### 回滚
...
<a id="deploy-records-agv-001-deployment-md-source-5"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-5documentsground_air_agv_mapping_deployment_logmd"></a>
## 历史材料 5：documents/GROUND_AIR_AGV_MAPPING_DEPLOYMENT_LOG.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s5-ground-air-agv-建图部署日志"></a>

<a id="deploy-records-agv-001-deployment-md-ground-air-agv-建图部署日志"></a>
### Ground-Air AGV 建图部署日志

<a id="deploy-records-agv-001-deployment-md-s5-2026-09-05-guard-版本不匹配诊断与兼容修复"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-05-guard-版本不匹配诊断与兼容修复"></a>
...
<a id="deploy-records-agv-001-deployment-md-s5-2026-09-01-epgeneral_map_stream-v0130-增量部署"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-01-epgeneral_map_stream-v0130-增量部署"></a>
...
<a id="deploy-records-agv-001-deployment-md-s5-2026-09-02-fast-lio-后置坐标转换-launch-增量部署"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-02-fast-lio-后置坐标转换-launch-增量部署"></a>
...
<a id="deploy-records-agv-001-deployment-md-s5-2026-09-02-坐标转换改为开机常驻"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-02-坐标转换改为开机常驻"></a>
...
<a id="deploy-records-agv-001-deployment-md-s5-2026-09-02-stage-manager-后置启动与指控接入"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-02-stage-manager-后置启动与指控接入"></a>
...
<a id="deploy-records-agv-001-deployment-md-s5-2026-09-02-tf-改为自启动常驻管理"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-02-tf-改为自启动常驻管理"></a>
...
<a id="deploy-records-agv-001-deployment-md-s5-2026-09-03-静态-tf-改由自启动-launch-直接管理"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-03-静态-tf-改由自启动-launch-直接管理"></a>
...
<a id="deploy-records-agv-001-deployment-md-s5-2026-09-03-建图预览坐标系契约修复与端侧验收"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-03-建图预览坐标系契约修复与端侧验收"></a>
...
<a id="deploy-records-agv-001-deployment-md-source-6"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-6documentsground_air_agv_relocalization_deploymentmd"></a>
## 历史材料 6：documents/GROUND_AIR_AGV_RELOCALIZATION_DEPLOYMENT.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s6-ground-air-agv-重定位部署说明"></a>

<a id="deploy-records-agv-001-deployment-md-ground-air-agv-重定位部署说明"></a>
### Ground-Air AGV 重定位部署说明

CCS 0.23.1 当前入口：[使用手册](../../USER_MANUAL.md#documents-user-manual-md) · [接口与配置](../../INTERFACE_REFERENCE.md#documents-interface-reference-md)。本页保留设备专项步骤；运行配置以脚本传入的工作空间 config/profile 为准，不能只修改包内默认 YAML。

<a id="deploy-records-agv-001-deployment-md-s6-运行契约"></a>

<a id="deploy-records-agv-001-deployment-md-运行契约"></a>
#### 运行契约
...
<a id="deploy-records-agv-001-deployment-md-s6-tf-上报"></a>

<a id="deploy-records-agv-001-deployment-md-tf-上报"></a>
#### TF 上报
...
<a id="deploy-records-agv-001-deployment-md-s6-部署边界"></a>

<a id="deploy-records-agv-001-deployment-md-部署边界"></a>
#### 部署边界
...
<a id="deploy-records-agv-001-deployment-md-s6-增量验收"></a>

<a id="deploy-records-agv-001-deployment-md-增量验收"></a>
#### 增量验收
...
<a id="deploy-records-agv-001-deployment-md-s6-回滚"></a>

<a id="deploy-records-agv-001-deployment-md-回滚-1"></a>
#### 回滚
...
<a id="deploy-records-agv-001-deployment-md-source-7"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-7documentsground_air_agv_relocalization_deployment_logmd"></a>
## 历史材料 7：documents/GROUND_AIR_AGV_RELOCALIZATION_DEPLOYMENT_LOG.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s7-ground-air-agv-重定位部署日志"></a>

<a id="deploy-records-agv-001-deployment-md-ground-air-agv-重定位部署日志"></a>
### Ground-Air AGV 重定位部署日志

<a id="deploy-records-agv-001-deployment-md-s7-2026-09-05-建图兼容回归修正"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-05-建图兼容回归修正"></a>
#### 2026-09-05 建图兼容回归修正
...
- 本次兼容修复保持 manager、重定位协议、常驻 TF 和已禁用的上电自启动设置。端侧聚焦测试、实际建图预检及一次无运动建图闭环均已通过，完整备份、地图校验值与最终清理状态统一记录于 [建图部署日志](DEPLOYMENT_GUIDE.md#documents-ground-air-agv-mapping-deployment-log-md)；以下 9 月 4 日重定位历史结果保持不变。


<a id="deploy-records-agv-001-deployment-md-s7-2026-09-04-实施记录"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-04-实施记录"></a>
#### 2026-09-04 实施记录
...
<a id="deploy-records-agv-001-deployment-md-s7-问题与修正"></a>

<a id="deploy-records-agv-001-deployment-md-问题与修正"></a>
#### 问题与修正
...
<a id="deploy-records-agv-001-deployment-md-s7-验收结果"></a>

<a id="deploy-records-agv-001-deployment-md-验收结果"></a>
#### 验收结果
...
<a id="deploy-records-agv-001-deployment-md-source-8"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-8documentsground_air_agv_task_deploymentmd"></a>
## 历史材料 8：documents/GROUND_AIR_AGV_TASK_DEPLOYMENT.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s8-ground-air-agv-地面任务部署"></a>

<a id="deploy-records-agv-001-deployment-md-ground-air-agv-地面任务部署"></a>
...
<a id="deploy-records-agv-001-deployment-md-source-9"></a>

<a id="deploy-records-agv-001-deployment-md-历史材料-9documentsground_air_agv_task_deployment_logmd"></a>
## 历史材料 9：documents/GROUND_AIR_AGV_TASK_DEPLOYMENT_LOG.md

> 归档原文；以下命令、状态与结论按原日期理解。

<a id="deploy-records-agv-001-deployment-md-s9-ground-air-agv-地面任务部署记录"></a>

<a id="deploy-records-agv-001-deployment-md-ground-air-agv-地面任务部署记录"></a>
### Ground-Air AGV 地面任务部署记录

<a id="deploy-records-agv-001-deployment-md-s9-2026-09-08-连续两轮实车复验通过"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-08-连续两轮实车复验通过"></a>
...
<a id="deploy-records-agv-001-deployment-md-s9-2026-09-08-本地故障修订尚未部署"></a>

<a id="deploy-records-agv-001-deployment-md-2026-09-08-本地故障修订尚未部署"></a>
...
<a id="deploy-records-agv-001-deployment-md-s9-部署结果"></a>

<a id="deploy-records-agv-001-deployment-md-部署结果"></a>
#### 部署结果
...
<a id="deploy-records-agv-001-deployment-md-s9-构建与增量测试"></a>

<a id="deploy-records-agv-001-deployment-md-构建与增量测试"></a>
#### 构建与增量测试
...
<a id="deploy-records-agv-001-deployment-md-s9-静态验收"></a>

<a id="deploy-records-agv-001-deployment-md-静态验收-2"></a>
#### 静态验收
...
<a id="deploy-records-agv-001-deployment-md-s9-回滚"></a>

<a id="deploy-records-agv-001-deployment-md-回滚-2"></a>
#### 回滚
...
<a id="deploy-records-agv-001-deployment-md-s9-待完成验收"></a>

<a id="deploy-records-agv-001-deployment-md-待完成验收"></a>
#### 待完成验收

实车验收待完成。现场需先确认时间同步和重定位，由操作者人工解锁并切入 OFFBOARD，再用不超过 0.1 m/s 的短路线验证航点顺序、2 秒停留、进度反馈、普通停止和运动中急停。急停后的 POSCTL 切换和闭锁解除仍由操作者完成。

<a id="deploy-records-agv-001-deployment-md-后续记录填写格式"></a>
## 后续记录填写格式
